...
namespace Calculator2
{
    class Reeipt
    {
        ...
        public Reeipt(string foretagsnamn, int orgnr, int receiptId, int productQty, DateTime issuedate, decimal productWeight, double totalPrice, double vat1, double sumOfItems, bool cash, bool credit, bool coupon)
        {
        ...
        void pdoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            int startY = 55;
            int Offset = 40;
            graphics.DrawString("Welcome to back for your shopping delight at ICA Nära", new Font("Courier New", 14),
