...
namespace databastestLocal {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(int employeeID, string name, string surname, string role) {
...
namespace databastestLocal.Database1DataSet2TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([employeeID] = @Original_employeeID) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_surname = 1 AND [surname] IS NULL) OR ([surname] = @Original_surname)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([employeeID], [name], [surname], [role]) VALUES (@" +
                "employeeID, @name, @surname, @role);\r\nSELECT employeeID, name, surname, role FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [employeeID] = @employeeID, [name] = @name, [surname] = @surname, [role] = @role WHERE (([employeeID] = @Original_employeeID) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_surname = 1 AND [surname] IS NULL) OR ([surname] = @Original_surname)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)));
SELECT employeeID, name, surname, role FROM Employees WHERE (employeeID = @employeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::databastestLocal.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employeeID, name, surname, role FROM dbo.Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT employeeID, name, surname, role\r\nFROM     Employees";
        ...
        public virtual int Fill(Database1DataSet2.EmployeesDataTable dataTable) {
        ...
        public virtual Database1DataSet2.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet2.EmployeesDataTable dataTable = new Database1DataSet2.EmployeesDataTable();
        ...
        public virtual int FillBy(Database1DataSet2.EmployeesDataTable dataTable) {
        ...
        public virtual Database1DataSet2.EmployeesDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Database1DataSet2.EmployeesDataTable dataTable = new Database1DataSet2.EmployeesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet2.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_employeeID, string Original_name, string Original_surname, string Original_role) {
        ...
        public virtual int Insert(int employeeID, string name, string surname, string role) {
        ...
        public virtual int Update(int employeeID, string name, string surname, string role, int Original_employeeID, string Original_name, string Original_surname, string Original_role) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surname, string role, int Original_employeeID, string Original_name, string Original_surname, string Original_role) {
            return this.Update(Original_employeeID, name, surname, role, Original_employeeID, Original_name, Original_surname, Original_role);
        }
    }
